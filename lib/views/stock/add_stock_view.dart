        ...
        body: Consumer<AddStockViewModel>(
          builder: (context, value, child) {
            return value.dataFetched == false
                ...
                : addStockViewModel.suppliersList.isEmpty
                    ? const Center(
                        child: Text(
                            'You can\'t add stock unless you add a supplier!'),
                      )
                    : Column(
                        children: [
                          Expanded(
                                            ...
                                            builder: (context, val9, child) {
                                              return Expanded(
                                                ...
                                                child: CustomDropDown(
                                                  list: val9.suppliersList,
                                                  value: val9.selectedSupplier,
                                                  hint: val9.selectedSupplier,
                                                  onChanged: (newVal) {
