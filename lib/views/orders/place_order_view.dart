                                    ...
                                    Consumer<PlaceOrderViewModel>(
                                      builder: (context, val1, child) =>
                                          CustomDropDown(
                                              ...
                                              onChanged: (newVal) {
                                                if (newVal != null) {
                                                  val1.selectedDesign = newVal;
                                                  val1.selectedDesignIndex = val1
                                                      .designNames
                                                      .indexOf(val1.selectedDesign);
                                                  if (newVal == 'none') {
                                      ...
                                      builder: (context, val2, child) =>
                                        ...
                                        onChanged: (newVal) {
                                          ...
                                          val2.selectedPaperSizePaperQualities
                                              .clear();
                                          val2.selectedPaperSizeIndexes.clear();
                                          // change the next dropdown according to the selected paper size

                                          if (val2.selectedPaperSize == 'none') {
                                            val2.selectedPaperSizePaperQualities
                                                .add('none');
                                            ...
                                            int index = 0;
                                            for (var paper in val2.rateList.paper) {
                                              // debugPrint(
                                            ...
                                            int rate = val2
                                                .rateList
                                                .paper[val2.selectedPaperSizeIndexes[
                                                    val2.selectedPaperSizePaperQualities
                                                        .indexOf(val2
                                    ...
                                    Consumer<PlaceOrderViewModel>(
                                      builder: (context, val3, child) =>
                                          CustomDropDown(
                                              ...
                                              value: val3.selectedPaperQuality,
                                              hint: val3.selectedPaperQuality,
                                              onChanged: (newVal) {
                                                val3.selectedPaperQuality = newVal!;
                                    ...
                                    Consumer<PlaceOrderViewModel>(
                                      builder: (context, val5, child) =>
                                          CustomDropDown(
                                              ...
                                              value: val5.selectedPaperCutting,
                                              hint: val5.selectedPaperCutting,
                                              onChanged: (newVal) {
                                                val5.selectedPaperCutting = newVal!;
                                                val5.selectedPaperCuttingIndex =
                                                    val5.paperCuttingNames.indexOf(
                                  ...
                                  children: [
                                    ...
                                    Consumer<PlaceOrderViewModel>(
                                      ...
                                      return CustomDropDown(
                                          ...
                                          value: val6.selectedBasicCuttingUnit,
                                          hint: val6.selectedBasicCuttingUnit,
                                          onChanged: (newVal) {
                                            val6.selectedBasicCuttingUnit = newVal!;
                                            debugPrint('New value is $newVal');
                                            if (val6.selectedBasicCuttingUnit ==
                                                'none') {
                                              val6.selectedBasicCuttingUnitIndex = 0;
                                              ...
                                              int? cuttingUnit = int.tryParse(val6
                                    ...
                                    Consumer<PlaceOrderViewModel>(
                                      builder: (context, val7, child) =>
                                          CustomDropDown(
                                              ...
                                              value: val7.selectedCopyVariant,
                                              hint: val7.selectedCopyVariant,
                                              onChanged: (newVal) =>
                                                  val7.copyVariantOnChange!(newVal)),
                                    ),
                                  ],
                                ),
                                Consumer<PlaceOrderViewModel>(
                                      ...
                                      children: [
                                        Row(
                                          children: [
                                            ...
                                            CustomDropDown(
                                                list: val8.copyPrint,
                                                value: val8.selectedCopyPrint,
                                                hint: val8.selectedCopyPrint,
                                                onChanged: (newVal) {
                                                  val8.selectedCopyPrint = newVal!;
                                                  val8.selectedCopyPrintIndex =
                                                      val8.copyPrint.indexOf(
                                                            ...
                                                            CustomDropDown(
                                                                ...
                                                                onChanged: (newVal) {
                                                                  ...
                                                                  if (val10
                                                                    ...
                                                                    int rate = val10
                                                                        .rateList
                                                                        .news[val10.selectedNewsPaperSizeIndexes[val10
                                                                            .selectedNewsPaperSizePaperQualities
                                                                            .indexOf(val10
                                                                                .selectedNewsPaperQuality)]]
                                                                        .rate;
                                    ...
                                    Consumer<PlaceOrderViewModel>(
                                      builder: (context, val9, child) =>
                                          CustomDropDown(
                                              ...
                                              onChanged: (newVal) {
                                                val9.selectedBinding = newVal!;
                                                val9.selectedBindingIndex = val9
                                                    .bindingNames
                                                    .indexOf(val9.selectedBinding);
                                              }),
                                    ),
                                  ],
                                ),
                                    ...
                                    Consumer<PlaceOrderViewModel>(
                                      builder: (context, val11, child) =>
                                          CustomDropDown(
                                              ...
                                              value: val11.selectedNumbering,
                                              hint: val11.selectedNumbering,
                                              onChanged: (newVal) {
                                                val11.selectedNumbering = newVal!;
                                                val11.selectedNumberingIndex = val11
                                                    .numberingNames
                                                    .indexOf(val11.selectedNumbering);
                                              }),
                                    ),
                                  ],
                                ),
