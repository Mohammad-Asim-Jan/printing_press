...
late AllOrdersViewModel allOrdersViewModel;
  ...
  void initState() {
    ...
    super.initState();
    allOrdersViewModel = Provider.of<AllOrdersViewModel>(context, listen: false);
  }
                                ...
                                itemBuilder: (BuildContext context, int index) {
                                  ...
                                  is CustomerCustomOrder) {
                                    ...
                                    return ListTile(
                                      ...
                                      leading: Text(customerCustomerOrder
                                          .customerOrderId
                                          .toString()),
                                      trailing: Text(customerCustomerOrder.totalAmount.toString()),
                                    );
                                  ...
                                  is StockOrderByCustomer) {
                                    ...
                                    return ListTile(
                                      ...
                                      leading: Text(stockOrderByCustomer
                                          .customerOrderId
                                          .toString()),
                                      trailing: Text(stockOrderByCustomer.totalAmount.toString()),
                                    );
                                  } else {
                                    return const Center(
